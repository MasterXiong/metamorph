...
if __name__ == '__main__':
    ...
    # python tools/distill.py --cfg configs/ft.yaml RNG_SEED 1409 DISTILL.SOURCE ft_baseline_KL_5_wo_PE+dropout/1409 MODEL.TYPE mlp DISTILL.PER_AGENT_SAMPLE_NUM 16000 MODEL.MLP.HN_INPUT True MODEL.MLP.HN_OUTPUT True MODEL.MLP.HN_HIDDEN True MODEL.MLP.LAYER_NUM 2 MODEL.MLP.INPUT_AGGREGATION limb_num MODEL.MLP.HN_GENERATE_BIAS True MODEL.MLP.CONTEXT_MASK True MODEL.MLP.CONTEXT_ENCODER_TYPE transformer MODEL.MLP.HN_INIT_STRATEGY bias_init OUT_DIR distilled_policy/MT_TF_to_HN-MLP_lr_1e-3_expert_size_64000/1409 DISTILL.BASE_LR 0.001 DISTILL.SAVE_FREQ 10 DISTILL.EPOCH_NUM 100
    ...
    # python tools/distill.py --cfg configs/ft.yaml --no_context_in_state RNG_SEED 1409 DISTILL.SOURCE ft_baseline_KL_5_wo_PE+dropout/1409 MODEL.TYPE hnmlp MODEL.MLP.LAYER_NUM 2 OUT_DIR distilled_policy/MT_TF_to_HN-MLP_v2_no_context_in_obs_lr_1e-3/1409 DISTILL.PER_AGENT_SAMPLE_NUM 16000 DISTILL.BASE_LR 0.001 DISTILL.SAVE_FREQ 5 DISTILL.EPOCH_NUM 50
