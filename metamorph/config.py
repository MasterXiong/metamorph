...
# layer num for GNN context encoder
_C.MODEL.MLP.GNN_LAYER_NUM = 3
...
_C.MODEL.HYPERNET.INPUT_AGGREGATION = 'limb_num'
...
_C.DISTILL.PER_AGENT_SAMPLE_NUM = 16000
...
_C.DISTILL.PER_AGENT_EPISODE_NUM = 8
_C.DISTILL.DOMAIN_RANDOMIZATION = False
